    ...
    <div style={{ display: "grid", gap: 14 }}>
      ...
      {!cur && view === "settle" && (
        <GrantSettleView prog={prog} isSsp={isSsp} progDef={progDef} progItems={progItems}
          progBudgets={progBudgets} setBudget={setBudget} settleDocs={settleDocs}
          prof={prof} sspP={sspP} busy={busy} saveProf={saveProf} onBack={() => setView("list")} />
      )}
      ...
      {cur && (
        ...
        {selCount > 0 && (
          <div>
            ...
            {isSsp
              ? selFormsSSP.map(f => (
                <div key={f.key} className="gdoc printable">
